...
class CustomInfoWindowAdapter(
    ...
    override fun getInfoWindow(p0: Marker): View? {
        ...
        binding.textRating.text = "Rating: ${place?.rating.toString()}"
        ...
        Glide.with(inflater.context).load(imageUrl).listener(MarkerCallback(p0)).override(50)
            .centerCrop().placeholder(
                R.drawable.sample_vinh_ha_long
            ).error(R.drawable.ic_no_image).into(binding.imageThumbnailPlace)
